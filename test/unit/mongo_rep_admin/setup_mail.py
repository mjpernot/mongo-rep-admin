...
"""Program:  setup_mail.py
    ...
    Description:  Unit testing of setup_mail in mongo_rep_admin.py.
...
class UnitTest(unittest.TestCase):
    ...
    def test_with_subj_list(self):
        ...
        mail = mongo_rep_admin.setup_mail([self.to_line], [self.subj],
                                          self.frm_line)
    ...
    def test_no_from_line(self):
        ...
        mail = mongo_rep_admin.setup_mail([self.to_line])
